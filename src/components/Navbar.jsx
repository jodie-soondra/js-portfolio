    ...
    <div className="bg-blue sm:px-16 px-6">
      ...
      <div className={!nav ? "sm:hidden fixed left-0 top-0 w-[60%] h-full border-r-2 border-cream border-opacity-75 bg-darkBlue ease-in-out duration-500" : "fixed left-[-100%]"}>
        <ul className={`${styles.heading4} p-4 mt-[100px]`}>
          <li className={`${styles.hoverOrange} p-4 border-b-2 border-opacity-50 border-cream`}><Link to="home" spy={true} smooth={true} offset={-90} duration={500}>Home</Link></li>
          <li className={`${styles.hoverOrange} p-4 border-b-2 border-opacity-50 border-cream`}><Link to="skills" spy={true} smooth={true} offset={-120} duration={500}>Skills</Link></li>
          <li className={`${styles.hoverOrange} p-4 border-b-2 border-opacity-50 border-cream`}><Link to="projects" spy={true} smooth={true} offset={-100} duration={500}>Projects</Link></li>
          <li className={`${styles.hoverOrange} p-4`}><Link to="contact" spy={true} smooth={true} offset={50} duration={500}>Contact</Link></li>
        </ul>
      </div>
    </div>
  )
